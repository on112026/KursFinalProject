...
- `POST /api/company/attach-user/` - Прикрепление пользователя к компании (только владелец)
...
### Поставщики
- `GET /api/suppliers/` - Получение списка поставщиков компании
- `POST /api/suppliers/` - Создание поставщика
- `GET /api/suppliers/{id}/` - Получение поставщика по ID
- `PUT /api/suppliers/{id}/` - Редактирование поставщика
...
- `PUT /api/products/{id}/` - Редактирование товара (quantity менять нельзя)
- `DELETE /api/products/{id}/` - Удаление товара

### Поставки
- `GET /api/supplies/` - Получение списка поставок
- `POST /api/supplies/create/` - Создание поставки товаров
